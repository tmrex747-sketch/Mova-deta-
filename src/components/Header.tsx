...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-white/10 bg-[#090c14]/90 backdrop-blur-md px-4 py-3 sm:px-6">
      <div className="flex items-center justify-between gap-2 max-w-7xl mx-auto">
        {/* Left: Brand Identity */}
        <div className="flex items-center gap-3">
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500/20 via-rose-500/10 to-amber-600/30 border border-amber-500/30 shadow-lg shadow-amber-500/10">
            <Film className="w-5 h-5 text-amber-400" />
            <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-2 ring-[#090c14]" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="font-cinzel text-lg sm:text-xl font-bold tracking-wider text-slate-100 uppercase">
                Mova Deta
              </span>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            <span className="text-[11px] max-w-[110px] truncate sm:max-w-none">
              {botStatus.connected
          ...
          {pendingScheduledCount > 0 && (
            <div
              className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-indigo-950/50 border border-indigo-500/30 text-indigo-300 text-xs font-semibold"
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 text-xs font-medium transition"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-black font-semibold text-xs shadow-md shadow-amber-500/20 active:scale-95 transition"
          >
            <Upload className="w-3.5 h-3.5 text-black" />
            <span className="hidden xs:inline">Quick Upload</span>
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center p-2 rounded-xl bg-slate-800/90 hover:bg-slate-700/90 border border-white/10 hover:border-amber-500/40 text-amber-400 hover:text-amber-300 transition shadow-sm active:scale-95 ml-0.5"
